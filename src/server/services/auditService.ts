...
export type AuditAction =
  ...
  | 'SSH_PRODUCTION_PROBE'
  | 'SSH_PRODUCTION_PROBE_SCHEDULE'
  | 'SSH_PRODUCTION_PROBE_AUTO_RUN'
  | 'RELEASE_GATE_POLICY_UPDATE'
  | 'RELEASE_EVIDENCE_SHARE_CREATE'
  | 'RELEASE_EVIDENCE_SHARE_READ'
  | 'RELEASE_EVIDENCE_SHARE_REVOKE'
  | 'SERVER_ACTION'
